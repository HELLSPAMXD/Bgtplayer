...
async def init():
    ...
    await Bikashh.start()
    try:
        await Bikashh.stream_decall("https://te.legra.ph/file/cec46da705f452b81f816.jpg")
    except:
        pass
    try:
        await Bikashh.stream_call(
            "https://te.legra.ph/file/cec46da705f452b81f816.jpg"
        )
    ...
    LOGGER("Bikash").info("Namikaze.. Player Started")
    await idle()
